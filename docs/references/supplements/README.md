...
Structured markdown views derived from primary sources (PDF/xlsx). **Not canonical** — use synthesized docs first; supplements fill gaps and aid search.

| File | Primary source | Canonical doc |
|------|----------------|---------------|
| [devsecops_tools.md](devsecops_tools.md) | Карта инструментов DevSecOps (PDF/OCR) | [04-tooling-catalog.md](../../04-tooling-catalog.md) |
